...
class TestInference(unittest.TestCase):
    ...
    def test_literal(self):
        ...
        self.assertEqual(literal(boolean, "==", True), boolean(True))
        self.assertEqual(literal(boolean, "==", False), boolean(False))
        self.assertEqual(literal(boolean, "!=", True), boolean(False))
        self.assertEqual(literal(boolean, "!=", False), boolean(True))
        self.assertEqual(literal(boolean(True), "==", True), boolean(True))
        self.assertEqual(literal(boolean(True), "==", False), impossible)
        self.assertEqual(literal(boolean(True), "!=", True), impossible)
        self.assertEqual(literal(boolean(True), "!=", False), boolean(True))
        self.assertEqual(literal(boolean(False), "==", True), impossible)
        self.assertEqual(literal(boolean(False), "==", False), boolean(False))
        self.assertEqual(literal(boolean(False), "!=", True), boolean(False))
        self.assertEqual(literal(boolean(False), "!=", False), impossible)
        self.assertEqual(literal(boolean, "==", 5), impossible)
        self.assertEqual(literal(boolean, "!=", 5), boolean)
        self.assertEqual(literal(boolean(True), "==", 5), impossible)
        self.assertEqual(literal(boolean(True), "!=", 5), boolean(True))
        self.assertEqual(literal(boolean(False), "==", 5), impossible)
        self.assertEqual(literal(boolean(False), "!=", 5), boolean(False))

        self.assertEqual(literal(union(null, boolean), "==", True), boolean(True))
        self.assertEqual(literal(union(null, boolean), "==", False), boolean(False))
        self.assertEqual(literal(union(null, boolean), "==", None), null)
        self.assertEqual(literal(union(null, boolean), "==", 5), impossible)

        self.assertEqual(literal(union(null, boolean), "!=", True), union(null, boolean(False)))
        self.assertEqual(literal(union(null, boolean), "!=", False), union(null, boolean(True)))
