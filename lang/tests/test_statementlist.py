...
class TestStatementlist(unittest.TestCase):
    ...
    def test_add(self):
        ...
        self.check(statements, [{"to": "#0", "fcn": "+", "args": ["x", "y"], "schema": "real"}])
    ...
    def test_add3(self):
        ...
        self.check(statements, [{"to": "#0", "fcn": "+", "args": ["x", "y", "z"], "schema": "real"}])
        self.check(result, {"name": "#0", "schema": "real", "data": "#0", "size": None})
    ...
    def test_mapadd(self):
        ...
        self.check(statements, [
            ...
            {"to": "#1", "fcn": "+", "args": ["xs[]", "#0"], "schema": "real"}
            ])
    ...
    def test_mapmapadd(self):
        ...
        self.check(statements, [
            ...
            {"to": "#1", "fcn": "+", "args": ["xss[][]", "#0"], "schema": "real"}
            ])
    ...
    def test_record(self):
        ...
        self.check(statements, [{"to": "#0", "fcn": "+", "args": ["x-a", "y"], "schema": "real"}])
        self.check(result, {"name": "#0", "schema": "real", "data": "#0", "size": None})
    ...
    def test_recordarray(self):
        ...
        self.check(statements, [
            ...
            {"to": "#1", "fcn": "+", "args": ["x-a[]", "#0"], "schema": "real"}
            ])
    ...
    def test_arrayrecord(self):
        ...
        self.check(statements, [
            ...
            {"to": "#1", "fcn": "+", "args": ["xs[]-b", "#0"], "schema": "real"}
            ])
    ...
    def test_arrayrecord3(self):
        ...
        self.check(statements, [
            {"to": "#0", "fcn": "$explode", "data": "y", "size": "xs[]-a[]@size", "schema": "real"},
            {"to": "#1", "fcn": "+", "args": ["xs[]-a[]", "#0"], "schema": "real"}
            ])
    ...
    def test_arrayrecord4(self):
        ...
        self.check(statements, [
            ...
            {"to": "#1", "fcn": "+", "args": ["xs[]-b-c", "#0"], "schema": "real"}
            ])
