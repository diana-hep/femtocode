...
class TestExecution(unittest.TestCase):
    ...
    def test_oldexample1(self):
        ...
        countdown = [oldexample.dataset.numEntries, 0, 0, 0, 0, 0]
        sarray_v0 = oldexample.dataset.groups[0].segments["xss[][]"].size
        sarray_v1 = oldexample.dataset.groups[0].segments["ys[]"].size
    
        loop.prerun.fcn(countdown, sarray_v0, sarray_v1)
        dataLength = countdown[1]
        sizeLength = countdown[2]
        ...
        loop.run.fcn(countdown, sarray_v0, sarray_v1, xdarray_v2, xdarray_v3, tarray_v4, tsarray_v5)
        self.assertEqual(countdown[:3], [2, 48, 20])
    ...
    def test_oldexample2(self):
        ...
        loop.run.fcn(countdown, sarray_v0, sarray_v1, xdarray_v2, xdarray_v3, tarray_v4, tsarray_v5)
        self.assertEqual(countdown[:3], [2, 48, 32])
    ...
    def test_minimal(self):
        ...
        countdown = [oldexample.dataset.numEntries, 0, 0]
        ...
        loop.run.fcn(countdown, darray_v0, darray_v1, tarray_v2)
        self.assertEqual(countdown[:3], [2, 2, 0])
    ...
    def test_no_explodes(self):
        ...
        countdown = [oldexample.dataset.numEntries, 0, 0, 0, 0]

        sarray_v0 = oldexample.dataset.groups[0].segments["ys[]"].size
        darray_v1 = oldexample.dataset.groups[0].segments["ys[]"].data
        tarray_v2 = [0] * oldexample.dataset.groups[0].segments["ys[]"].dataLength
        
        loop.run.fcn(countdown, sarray_v0, darray_v1, tarray_v2)
        self.assertEqual(countdown[:3], [2, 8, 2])
    ...
    def test_simple_explode(self):
        ...
        loop.run.fcn(countdown, sarray_v0, xarray_v1, darray_v2, tarray_v3)
        self.assertEqual(countdown[:3], [2, 8, 2])
    ...
    def test_simple_explode2(self):
        ...
        loop.run.fcn(countdown, sarray_v0, xarray_v1, darray_v2, tarray_v3)
        self.assertEqual(countdown[:3], [2, 12, 8])
    ...
    def test_megaexample1(self):
        ...
        loop.run.fcn(countdown, sarray_v0, sarray_v1, xdarray_v2, xdarray_v3, xarray_v4, tarray_v5, tsarray_v6)
        self.assertEqual(countdown[:3], [2, 48, 20])
